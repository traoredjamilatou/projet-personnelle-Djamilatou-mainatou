...
<!-- Marketing messaging and featurettes
      ...
      <div class="container marketing">
        ...
        <div class="row">
          <div class="col-lg-4">
            <img class="rounded-circle" src="12.jpg" alt="Generic placeholder image" width="150" height="150">
            <h2>Titre</h2>
          ...
          <div class="col-lg-4">
            <img class="rounded-circle" src="1.jpg" alt="Generic placeholder image" width="150" height="150">
            <h2>Titre</h2>
          ...
          <div class="col-lg-4">
            <img class="rounded-circle" src="6.jpg" alt="Generic placeholder image" width="150" height="150">
            <h2>Titre</h2>
